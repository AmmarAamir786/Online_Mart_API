...
KAFKA_INVENTORY_VALIDATION_GROUP_ID = config("KAFKA_INVENTORY_VALIDATION_GROUP_ID", cast=str)
...
KAFKA_INVENTORY_UPDATE_CONSUMER_GROUP_ID = config("KAFKA_INVENTORY_UPDATE_CONSUMER_GROUP_ID", cast=str)
